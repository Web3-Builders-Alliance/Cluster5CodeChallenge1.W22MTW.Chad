...
import { Uint128, BalanceResponse, ExecuteMsg, Expiration, Timestamp, Uint64, TokenSelect, Addr, InfoResponse, InstantiateMsg, QueryMsg, Token, Token1ForToken2PriceResponse, Token2ForToken1PriceResponse } from "./WasmSwap.types";
export interface WasmSwapReadOnlyInterface {
...
export class WasmSwapQueryClient implements WasmSwapReadOnlyInterface {
...
export interface WasmSwapInterface extends WasmSwapReadOnlyInterface {
  contractAddress: string;
  sender: string;
  addLiquidity: ({
    expiration,
...
export class WasmSwapClient extends WasmSwapQueryClient implements WasmSwapInterface {
